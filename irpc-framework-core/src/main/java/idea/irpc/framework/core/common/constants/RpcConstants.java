package idea.irpc.framework.core.common.constants;

/**
 * @author ：Mr.Zhang
 * @date ：Created in 2022/3/3 18:46
 */
public class RpcConstants {
    ...
    public static final Integer DEFAULT_CONNECTION_NUMS = DEFAULT_THREAD_NUMS + DEFAULT_QUEUE_SIZE;
